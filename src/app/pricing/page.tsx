  ...
  const plans = [
    {
      ...
      price: '₹0',
      period: 'forever',
      description: 'Ideal for fast temporary private conversations with zero sign-up required.',
      features: [
    ...
    },
    {
      ...
      description: 'For privacy-conscious professionals requiring higher room capacity and extended lifespans.',
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        'Custom / higher member limits (up to 25+ members)',
