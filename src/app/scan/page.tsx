  ...
  const handleValidRoomCode = useCallback(
    (rawPayload: string) => {
      ...
      if (!roomCode) {
        ...
        toast('Invalid TempLink QR code', 'error');
        return;
      }
      ...
      if (process.env.NODE_ENV !== 'production') {
        console.log(`[QR] Scan detected. Payload: ${rawPayload}, Extracted: ${roomCode}. Returning to Join Room.`);
      }

      // DO NOT AUTO-JOIN.
      // Redirect to /join?code=XXXX-XXXX&scanned=1 so code is auto-filled and user explicitly clicks Join Room.
      setTimeout(() => {
